...
;       } Label:    ;this label would not be catched correctly here
    ...
    ;in most cases there shouldn't be any valuable info for the code explorer on any of these lines (including any code on last line after ")")
      ...
      ; Msgbox % Line 
             ; . "`nMatch3: " Match.Value(3)
             ; . "`nMatch4: " Match.Value(4) " JoinString: >" JoinString  
             ; . "<`nMatch5: " Match.Value(5) " AllowTrimLeft:" AllowTrimLeft 
             ; . "`nMatch6: " Match.Value(6) " AllowTrimRight: " AllowTrimRight 
             ; . "`nMatch7: " Match.Value(7) " AllowComments: " AllowComments
